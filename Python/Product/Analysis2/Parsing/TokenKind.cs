...
namespace Microsoft.PythonTools.Analysis.Parsing {
    ...
    public enum TokenKind {
        ...
        AddEqual = 0x10 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        Subtract = 0x11 | TokenUsage.BinaryOrUnaryOperator | TokenCategory.Operator,
        SubtractEqual = 0x11 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        Power = 0x12 | TokenCategory.Operator,
        PowerEqual = 0x12 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        Multiply = 0x13 | TokenUsage.BinaryOperator | TokenCategory.Operator,
        MultiplyEqual = 0x13 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        MatMultiply = 0x14 | TokenUsage.BinaryOperator | TokenCategory.Operator,
        MatMultiplyEqual = 0x14 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        ...
        FloorDivideEqual = 0x15 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        Divide = 0x16 | TokenUsage.BinaryOperator | TokenCategory.Operator,
        DivideEqual = 0x16 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        Mod = 0x17 | TokenUsage.BinaryOperator | TokenCategory.Operator,
        ModEqual = 0x17 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        LeftShift = 0x18 | TokenUsage.BinaryOperator | TokenCategory.Operator,
        LeftShiftEqual = 0x18 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        RightShift = 0x19 | TokenUsage.BinaryOperator | TokenCategory.Operator,
        RightShiftEqual = 0x19 | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        BitwiseAnd = 0x1A | TokenUsage.BinaryOperator | TokenCategory.Operator,
        BitwiseAndEqual = 0x1A | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        BitwiseOr = 0x1B | TokenUsage.BinaryOperator | TokenCategory.Operator,
        BitwiseOrEqual = 0x1B | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        ExclusiveOr = 0x1C | TokenUsage.BinaryOperator | TokenCategory.Operator,
        ExclusiveOrEqual = 0x1C | TokenUsage.AugmentedAssign | TokenCategory.Operator,
        ...
        Assign = 0x3B | TokenUsage.None | TokenCategory.Operator,
        ...
        KeywordIn = 0x53 | TokenUsage.BinaryOperator | TokenCategory.Keyword,
        KeywordIs = 0x54 | TokenUsage.BinaryOperator | TokenCategory.Keyword,
